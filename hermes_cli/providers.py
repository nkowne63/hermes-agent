...
HERMES_OVERLAYS: Dict[str, HermesOverlay] = {
    ...
    "devin-acp": HermesOverlay(transport="codex_responses", auth_type="external_process",
                               base_url_override="acp://devin", base_url_env_var="DEVIN_ACP_BASE_URL"),
    "claude-acp": HermesOverlay(transport="codex_responses", auth_type="external_process",
                                base_url_override="acp://claude", base_url_env_var="CLAUDE_ACP_BASE_URL"),
...
_ALIAS_GROUPS: Dict[str, Tuple[str, ...]] = {
    ...
    "copilot-acp": ("github-copilot-acp",), "devin-acp": ("devin", "devin-acp-agent"),
    "claude-acp": ("claude-agent-acp", "anthropic-acp"), "openai-codex": ("chatgpt", "chatgpt-codex"),
...
_LABEL_OVERRIDES: Dict[str, str] = {
    ...
    "copilot-acp": "GitHub Copilot ACP", "devin-acp": "Devin ACP", "claude-acp": "Claude ACP",
